...
class UrineMicroscopy(models.Model):
    ...
    cloxacillin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    ciprofloxacin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    lincomycin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    flucloxacillin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    tetracycline = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    ampicillin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    erythromycin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    roxithromycin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    augmentin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    cotrimoxazole = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    cephalexin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    dalacin_c = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    gentamycin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    streptomycin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    ceftriaxone = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    chloramphenicol = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    nitrofurantoin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    nalidixic_acid = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    cefuroxime = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    ceftazidime = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    ofloxacin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
    pefloxacin = models.CharField(max_length=1, choices=SEVERITY_CHOICES, blank=True, null=True)
